...
function mostrarLletres($arr)
{
    for ($i = 0; $i < count($arr); $i++) {
        if (isset($_POST["pantalla"]) && $_POST["pantalla"] == $arr[$i]) {
            // retorna string si l'input s'ha inicialitzat i al valor es igual a algun de l'array
    ...
    // si no es compleix cap cop, surt del bucle i retorna la string buida
    return $string;
}
...
<body data-joc="2022-10-07">
    <form name="php-logic" method="post">
        <div class="main">
            <h1>
        ...
        <p class="hide" id="message" style="">MISSATGE D'ERROR</p>
            ...
            <div class="cursor-container">
                <input type="hidden" id="input-word" name="pantalla" value="">
                <p id="input-word" name="pantalla-ex"><span id="test-word"></span><span id="cursor">|</span></p>
            </div>
            ...
            <div class="button-container">
                <button id="delete-button" type="button" title="Suprimeix l'última lletra" onclick="suprimeix()">
                    Suprimeix</button>
            ...
            <div class="scoreboard">
                <div>Has trobat <span id="letters-found">0</span> <span id="found-suffix">funcions</span><span id="discovered-text">.<input type="text" id="input-word" name="pantalla-ex" value="<?php echo mostrarLletres($arr); ?>"></span>
                </div>
                <div id="score"></div>
                <div id="level"></div>
    ...
    <script>
        ...
        function afegeixLletra(lletra) {
            ...
            document.getElementById("input-word").value += lletra
        }

        function suprimeix() {
            document.getElementById("test-word").innerHTML = document.getElementById("test-word").innerHTML.slice(0, -1)
            document.getElementById("input-word").value = document.getElementById("input-word").value.slice(0, -1)
        }
